package com.terraformersmc.cinderscapesold.decorator;
...
public class CountSafelistRangeCeilingDecorator extends Decorator<CountSafelistRangeDecoratorConfig> {
